...
public class Glacier2Client {
    ...
    public static void connect(final Class serviceCls, final Glacier2Callback callback) {
        ...
        try {
            File file = new File("iceclient_glacier2.properties");
            ...
            //
            // if(initData.properties.getPropertyAsIntWithDefault("IceSSL.UsePlatformCAs",
            // 0) == 0) {
        ...
        sessionFactoryHelper = new Glacier2.SessionFactoryHelper(initData, new Glacier2.SessionCallback() {
            ...
            public void connected(SessionHelper sessionHelper) throws SessionNotExistException {
                ...
                try {
                    ObjectPrx base = _sessionHelper.communicator().stringToProxy(realSvName);
            ...
            public void createdCommunicator(SessionHelper sessionHelper) {
                ...
                // if(communicator.getProperties().getPropertyAsIntWithDefault("IceSSL.UsePlatformCAs",
                // 0) == 0) {
                // try {
                // java.io.InputStream certStream = new FileInputStream(new
                // File("/Users/dengliaoyan/Documents/Work/Workspaces/Java_workspaces/iceTicketProject/target/classes/client.jks"));
                // IceSSL.Plugin plugin =
                // (IceSSL.Plugin)communicator.getPluginManager().getPlugin("IceSSL");
